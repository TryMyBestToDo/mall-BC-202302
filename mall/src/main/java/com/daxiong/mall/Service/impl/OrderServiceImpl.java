...
import com.daxiong.mall.model.dao.CartMapper;
import com.daxiong.mall.model.dao.OrderItemMapper;
import com.daxiong.mall.model.dao.OrderMapper;
import com.daxiong.mall.model.dao.ProductMapper;
...
import com.daxiong.mall.model.vo.OrderItemVO;
import com.daxiong.mall.model.vo.OrderVO;
import com.daxiong.mall.util.OrderCodeFactory;
import com.daxiong.mall.util.QRCodeGenerator;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public void finish(String orderNo, User user) {
        Order order = orderMapper.selectByOrderNo(orderNo);
        //查不到订单，报错
        if (order == null) {
            throw new MallException(MallExceptionEnum.NO_ORDER);
        ...
        //如果是普通用户，就要校验订单的所属
        if (!userService.checkAdminRole(user) && !order.getUserId()
                .equals(user.getId())) {
            throw new MallException(MallExceptionEnum.NOT_YOUR_ORDER);
        }
        //发货后可以完结订单
